  ...
  template: `
    <div class="locations-page">
      ...
      <section class="surface">
        ...
        <div class="success-state" *ngIf="successMessage() && !isLoading()">
          {{ successMessage() }}
        </div>
            ...
            <tbody>
              <tr *ngFor="let location of locations(); trackBy: trackByLocationId">
                ...
                <td>
                  <span
                    class="badge"
                    [class.badge-active]="location.active"
                    [class.badge-inactive]="!location.active"
                  >
                ...
                <td>
                  <div class="actions">
                    <button class="btn btn-soft" type="button" (click)="editLocation(location)">
                      Editar
                    </button>
...
export class LocationListComponent implements OnInit {
  ...
  loadLocations(): void {
    ...
    this.locationService
      ...
      .subscribe({
        ...
        error: (error) =>
          this.errorMessage.set(extractHttpErrorMessage(error, 'No se pudieron cargar las sedes.')),
      });
  }
  ...
  toggleActive(location: LocationResponse): void {
    this.locationService.patchLocation(location.id, { active: !location.active }).subscribe({
      ...
      error: (error) =>
        this.errorMessage.set(
          extractHttpErrorMessage(error, 'No se pudo actualizar el estado de la sede.'),
        ),
    });
  }
